...
typedef enum En_timer1Mode_t{
	...
	T1_COMP_MODE_ICR1_TOP = 0x0018,T1_PWM_Phase_8=0x0100,
	T1_PWM_Phase_9=0x0200,T1_PWM_Phase_10=0x0300,T1_PWM_Fast_8=0x0108,
	T1_PWM_Fast_9=0x0208,T1_PWM_Fast_10=0x0308,T1_PWM_Fast_OCR1A=0x0318
...
typedef enum En_timer1OC_t{
	...
	T1_OC1A_OC1B=0xA000,T1_OC1A_SET=0xC000,T1_OC1B_SET=0x3000
}En_timer1OC_t;
